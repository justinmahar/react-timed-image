...
By default, client-side cache-busting is enabled via [react-uncached-image](https://devboldly.github.io/react-uncached-image/), 
...
<Playground>
  <TimedImage src="https://github.com/devboldly/react-timed-image/workflows/Deploy/badge.svg" interval={3000} />
</Playground>

> Note: This example has since been turned into a Markdown enabled component, [BuildStatusBadge](https://devboldly.github.io/react-build-status-badge/).